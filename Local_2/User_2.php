...
<div id="bodega" class="slide"> 
            <h2 style="margin-left:21%;">Contenido Local 2</h2><br>
...
<div class="bodega-slider" style="margin-top:1%;">
    ...
    <div class="sliders" id="Pollo">
        ...
        <div class="shop-content">
            <?php
            $consultar_productos = mysqli_query($conex, "SELECT l.*, p.Precio_Producto FROM `local_2` l JOIN `productos` p ON l.Nombre_Producto = p.nombre_Producto WHERE l.`Tipo` = 'Pollo' AND l.Cantidad_Kilos > 0");
    ...
    <div class="sliders" id="Cerdo" style="display: none;">
        ...
        <div class="shop-content">
            <?php
            $consultar_productos = mysqli_query($conex, "SELECT l.*, p.Precio_Producto FROM `local_2` l JOIN `productos` p ON l.Nombre_Producto = p.nombre_Producto WHERE l.`Tipo` = 'Cerdo' AND l.Cantidad_Kilos > 0");
            $resultado_final = mysqli_num_rows($consultar_productos);
    ...
    <div class="sliders" id="Vacuno" style="display: none;">
        ...
        <div class="shop-content">
            <?php
            $consultar_productos = mysqli_query($conex, "SELECT l.*, p.Precio_Producto FROM `local_2` l JOIN `productos` p ON l.Nombre_Producto = p.nombre_Producto WHERE l.`Tipo` = 'Vacuno' AND l.Cantidad_Kilos > 0");
            $resultado_final = mysqli_num_rows($consultar_productos);
    ...
    <div class="sliders" id="Pavo" style="display: none;">
        ...
        <div class="shop-content">
            <?php
            $consultar_productos = mysqli_query($conex, "SELECT l.*, p.Precio_Producto FROM `local_2` l JOIN `productos` p ON l.Nombre_Producto = p.nombre_Producto WHERE l.`Tipo` = 'Pavo' AND l.Cantidad_Kilos > 0");
            $resultado_final = mysqli_num_rows($consultar_productos);
    ...
    <div class="sliders" id="Embutidos" style="display: none;">
        ...
        <div class="shop-content">
            <?php
            $consultar_productos = mysqli_query($conex, "SELECT l.*, p.Precio_Producto FROM `local_2` l JOIN `productos` p ON l.Nombre_Producto = p.nombre_Producto WHERE l.`Tipo` = 'Embutidos' AND l.Cantidad_Kilos > 0");
            $resultado_final = mysqli_num_rows($consultar_productos);
    ...
    <div class="sliders" id="Congelados" style="display: none;">
        ...
        <div class="shop-content">
            <?php
            $consultar_productos = mysqli_query($conex, "SELECT l.*, p.Precio_Producto FROM `local_2` l JOIN `productos` p ON l.Nombre_Producto = p.nombre_Producto WHERE l.`Tipo` = 'Congelados' AND l.Cantidad_Kilos > 0");
            $resultado_final = mysqli_num_rows($consultar_productos);
    ...
    <div class="sliders" id="Abarrotes" style="display: none;">
        ...
        <div class="shop-content">
            <?php
            $consultar_productos = mysqli_query($conex, "SELECT l.*, p.Precio_Producto FROM `local_2` l JOIN `productos` p ON l.Nombre_Producto = p.nombre_Producto WHERE l.`Tipo` = 'Abarrotes' AND l.Cantidad_Kilos > 0");
            $resultado_final = mysqli_num_rows($consultar_productos);
    ...
    <!-- link js  -->
    <script src="http://localhost/Bodega/Local_2/assent_Local2/js/Local_2_1.js"></script>
    <script>
    function Pollo() {
