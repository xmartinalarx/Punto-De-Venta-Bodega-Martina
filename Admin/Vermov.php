...
<div class="centrado" id="carga"><div class="lds-ring"><div></div><div></div><div></div><div></div></div></div><!-- loader -->    
    ...
    <main class="cont">
        ...
        <div class="arriva"><h3 class ="logo3"><a class="logo"><span>Bodega</span>Martina</a></h3></div>
            ...
            <h1>Búsqueda de Movimientos Diarias E mensuales</h1>
                <form action="Resultado_movimiento.php" method="post">
                    ...
                    <label for="tipoBusqueda2">Seleccione el tipo de Local:</label><br>
                    <select id="tipoBusqueda2" name="tipoBusqueda2">
